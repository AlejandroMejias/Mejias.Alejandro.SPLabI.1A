...
{
    int returnAux = -1;
    int tam = ll_len(this); // Solicito el tamaño actual de la lista

    if(this != NULL)
    {
        while( tam > 0)
        {
            ll_remove(this,0); // Comenzamos a borrar desde el principio de la lista, hasta que el tamaño de la lista sea 0
            tam--;
        }
        returnAux = 0;
    }
...
LinkedList* ll_clone(LinkedList* this)
{
    ...
    if(this != NULL)
    {
        cloneArray = ll_subList(this,0,tam); // Copia la lista desde el primer elemento hasta el tamaño maximo de la lista
    }
...
int ll_sort(LinkedList* this, int (*pFunc)(void*,void*), int order)
{
    ...
    {
        tam = ll_len(this); // Consigo el tamaño de la lista
        for(i = 0; i < tam; i++)
        {
